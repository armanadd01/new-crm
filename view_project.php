...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<dl>
								<dt><b class="border-bottom border-primary">Service Type</b></dt>
								<dd><?php echo ucwords($name) ?></dd>
								<dt><b class="border-bottom border-primary">Brief of Service</b></dt>
								<dd><?php echo html_entity_decode($description) ?></dd>
							</dl>
							<dl>
							    <dt><b class="border-bottom border-primary">Client ID</b></dt>
								<dd><?php echo ucwords($client) ?></dd>
							</dl>
							<dl>
							    <dt><b class="border-bottom border-primary">File Type</b></dt>
								<dd><?php echo ucwords($file) ?> / <?php echo ucwords($subfile) ?></dd>
							</dl>
							<dl>
							    <dt><b class="border-bottom border-primary">Folder Location</b></dt>
								<dd><?php echo ucwords($folder) ?></dd>
							</dl>
						</div>
						<div class="col-md-6 col-xs-6">
							<dl>
								<dt><b class="border-bottom border-primary">Project Start Date</b></dt>
								<dd><?php echo date("F d, Y",strtotime($start_date)) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">Deadline End Date</b></dt>
								<dd><?php echo date("F d, Y",strtotime($end_date)) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">Deadline End Time</b></dt>
								<dd><?php echo date("h:i:s A",strtotime($time)) ?></dd>
							</dl>
								...
								<dd>
									<?php
									  if($stat[$status] =='Pending'){
									  	echo "<span class=''>{$stat[$status]}</span>";
									  }elseif($stat[$status] =='Started'){
									  	echo "<span class=''>{$stat[$status]}</span>";
									  }elseif($stat[$status] =='On-Progress'){
									  	echo "<span class=''>{$stat[$status]}</span>";
									  }elseif($stat[$status] =='Finished'){
									  	echo "<span class=''>{$stat[$status]}</span>";
							...
							<dl>
								...
								<dd>USD <?php echo ucwords($price) ?></dd>
							</dl>
							<!--<dl>
								<dt><b class="border-bottom border-primary">Customer Service/Project Manager</b></dt>
								<dd>
	...
	<div class="row">
		<div class="col-md-6 col-xs-12">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Production/Team Member/s:</b></span>
					<div class="card-tools">
		...
		<div class="col-md-6 col-xs-12">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Customer Service/Project Manager</b></span>
					<div class="card-tools">
						<!-- <button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="manage_team">Manage</button> -->
					</div>
				</div>
		...
		<!--<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Brief List:</b></span>
					<?php// if($_SESSION['login_type'] != 3): ?>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> New Brief</button>
					</div>
				<?php //endif; ?>
				</div>
	...
	<!--<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Production Progress/Activity</b>
					<div class="card-tools">
...
<script>
	...
	$('#print').click(function(){
		...
		var _d = "<p class='text-center'><b>Project Detail as of (<?php echo date("F d, Y") ?>)</b></p>"
		_p.prepend(_d)
		_p.prepend(_h)
